...
file_list, download_time =fgetcols("list-of-download-files.dat")
...
new_timestamps={}
for url, timing in zip(file_list,download_time):
    download=False
    ...
    try:
        ...
        #print 'Timming last/tick/now '+str(last_time) +' / '+str(tick_time)+' / ' + str(utc_now)
